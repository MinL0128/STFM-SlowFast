...
def get_bullying10k_data(batch_size, num_workers=0, same_da=False, **kwargs):
    ...
    train_datasets = Bullying10k(r"/root/autodl-tmp/Bullying10K_data/", train=True,
                                 transform=test_transform if same_da else train_transform, step=kwargs["step"],
                                 gap=kwargs["gap"])
    test_datasets = Bullying10k(r"/root/autodl-tmp/Bullying10K_data/", train=False, transform=test_transform, step=kwargs["step"],
                                gap=kwargs["gap"])
...
if __name__ == "__main__":
    ...
    # a = Bullying10k(r"G:/Bullying10K-main/", train=True, step=10, gap=10)
    ...
    a = Bullying10k(r"/root/autodl-tmp/Bullying10K_data/", train=True, step=10, gap=10)
    l = torch.utils.data.DataLoader(
        a, batch_size=10,
        pin_memory=True, drop_last=True, shuffle=True, num_workers=0
    )
